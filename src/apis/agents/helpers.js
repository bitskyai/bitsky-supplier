...
const { validateAgentAndUpdateState } = require('../../util/utils');
...
async function activateAgent(gid, securityKey) {
  try {
    ...
    if(originalAgent.state === AGENT_STATE.draft){
      throw new HTTPError(400, null, {globalId: gid}, 'dia_0017400001');
    }else if(originalAgent.state === AGENT_STATE.deleted){
    ...
    }else if(originalAgent.state === AGENT_STATE.active){
